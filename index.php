    ...
    <body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="https://elcomercio.pe/resizer/EPdBN7VtCoVDHpu4J2rlM5Bsg7c=/980x0/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/DIQKACJ4DFDMLDTL5UBODECBQQ.jpg" alt="..." /></div>
                <div class="col-lg-5">
                    <h1 class="font-weight-light">Museo Inclusivo</h1>
                    <p>El Museo Inclusivo favorece la cohesión social y combate la exclusión, la discriminación y la desigualdad. Trabaja con y para toda la sociedad, sin excepciones. Muchas personas tienen que superar importantes barreras antes de ser aceptadas como ciudadanos de pleno derecho.</p>
